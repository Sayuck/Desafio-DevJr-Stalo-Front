...
export interface InputProps extends ChakraInputProps {
  ...
  /**
   * React Hook Form error object or object containing the
   * error message.
   *
   * @example
   *   const {
...
/**
 * This component is a wrapper around the Chakra UI Input
 * component.
 *
 * Renders a input field with a FormLabel and a
 * FormErrorMessage.
 *
 * Also, it wraps the field in a InputGroup to support
 * chakra's InputAddon & InputElement.
 *
